    ...
    <>
      ...
      {result.total === 0 ? (
        ...
        <>
          ...
          <PaginationBar page={result.page} pageCount={result.pageCount} total={result.total} pathname="/crm/notificaciones" params={{ ver: unreadOnly ? "no-leidas" : undefined }} label="avisos" />
        </>
      )}
    </>
  );
